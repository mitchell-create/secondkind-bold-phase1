...
Imported: 2026-05-03
Adaptations: none — verbatim. In our codebase the equivalent context lives in clients/<slug>/brand.yaml + avatar.yaml + product/*.yaml; this skill expands the schema we capture.
-->
