<!--
Source: github.com/DV0x/creative-ad-agent (MIT License)
Author: DV0x
Path: agent/.claude/skills/hook-methodology/SKILL.md
Imported: 2026-05-03
Adaptations: none — verbatim. Used as system context in strategy/angle_multiplier.py.
References file paths in DV0x's repo (agent/files/research/...) — when used here, the equivalent context comes from the brand/product/avatar YAMLs loaded in models/loader.py.
-->
